const Footer = () => {
  return (
    <footer className='container-fluid d-flex align-items-center mt-auto px-4 py-3 bg-dark footer'>
      ...
      <div className='col p-0 d-flex align-items-center justify-content-end'>
        <p className='mb-0 me-1 d-inline-block text-light'>Link to the repo</p>
        <a
